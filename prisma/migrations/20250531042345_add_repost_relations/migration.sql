...
-- CreateIndex
CREATE INDEX "Post_repostPostId_idx" ON "Post"("repostPostId");
...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_repostPostId_fkey" FOREIGN KEY ("repostPostId") REFERENCES "Post"("id") ON DELETE CASCADE ON UPDATE CASCADE;
